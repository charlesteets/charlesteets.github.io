...
// Scroll to Top button
        ...
        function displayProjectDetails(projectName) {
         ...
         if(projectName == 'bible') {
            ...
            projDeets.innerHTML = "<p>The Important File Tracker is an app I built using .NET, C#, WPF, and JSON. Its main purpose is to bookmark important files on your computer for quick and easy access, allow you to make notes about them, and back them up. Check out the full app <a href=\"https://github.com/charlesteets/ImportantFileTracker\">here</a> or check out the devlog <a href=\"https://charlesteetsdevlog.blogspot.com/search/label/ImportantFileTracker\">here</a>.</p>";
         }
